...
<footer class="bg-dark text-center text-white">
  <!-- Copyright -->
  <div class="p-3 d-flex justify-content-between" style="background-color: #343A40;">
    <p style="font-size: 1.2em;">© 2021 Copyright: <a href="sushipay-pemweb.xyz" style="font-size: 1.2em; color: cornflowerblue;">paycation.xyz</a> All rights reserved.</p>
    <p style="font-size: 1.2em;">"You Sleep, You Pay, We Happy!"</p>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
